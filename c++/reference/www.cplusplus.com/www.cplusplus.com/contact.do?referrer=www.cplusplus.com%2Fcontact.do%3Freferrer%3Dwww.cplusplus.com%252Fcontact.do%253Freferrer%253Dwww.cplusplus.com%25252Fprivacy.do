...
<tr class="odd"><td class="field">URL</td><td class="value"><input type="checkbox" name="sendreferrer" id="sendreferrer" checked >www.cplusplus.com/contact.do?referrer=www.cplusplus.com%2Fcontact.do%3Freferrer%3Dwww.cplusplus.com%252Fprivacy.do<input name="referrer" value="www.cplusplus.com/contact.do?referrer=www.cplusplus.com%2Fcontact.do%3Freferrer%3Dwww.cplusplus.com%252Fprivacy.do" type=hidden> </font></td><td class="description">You reached this form following a link in this page.<br>Check this box if you wish to include this info in your message.</td></tr>
<tr class="odd"><td class="field">Content*</td><td class="value" colspan="2"><textarea name="cont" cols="80" rows="15"></textarea> </td></tr>
<tr class="even"><td class="field">Human validation*</td><td class="value" align="right"><img src="/token.do?token=2c6dd7c6af91d24891c2ab439253f9bb"><input type="hidden" name="tokenid" value="2c6dd7c6af91d24891c2ab439253f9bb"> &nbsp; <input name="token" value="" type="text" size="10" maxlength="5" class="txt"> </td><td class="description">Please type the 5-digit code shown on the left.<br>This helps prevent automated submissions.</td></tr>
...
<div id="I_bottom">
<div id="I_footer">
	<a href="/">Home page</a> | <a href="/privacy.do">Privacy policy</a><br>&copy; cplusplus.com, 2000-2016 - All rights reserved - <i>v3.1</i><br><a href="/contact.do?referrer=www.cplusplus.com%2Fcontact.do%3Freferrer%3Dwww.cplusplus.com%252Fcontact.do%253Freferrer%253Dwww.cplusplus.com%25252Fcontact.do%25253Freferrer%25253Dwww.cplusplus.com%2525252Fprivacy.do">Spotted an error? contact us</a>
</div>
</div>
